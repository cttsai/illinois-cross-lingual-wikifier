 ...
 */
public class MultiLingualNERAnnotator extends Annotator {


    private final Logger logger = LoggerFactory.getLogger(MultiLingualNERAnnotator.class);
     ...
     * @throws IOException
     */
    public MultiLingualNERAnnotator(String viewName, Language lang, String configFile) throws IOException {
        super(viewName, new String[]{}, true, new ResourceManager(configFile));
    ...
    public void addView(TextAnnotation textAnnotation){
        ...
        textAnnotation.addView(viewName, nerView);
    }
